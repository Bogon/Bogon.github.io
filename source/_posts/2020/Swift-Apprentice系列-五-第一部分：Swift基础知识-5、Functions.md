...
![playground](http://cdn.xuebaonline.com/sasb-f-stp1.png "")
...
![playground](http://cdn.xuebaonline.com/sasb-f-stp2.png "")

另外，你还可以按住Option键并单击函数名，然后在方便的弹出框中显示你的文档，如下所示：

![playground](http://cdn.xuebaonline.com/sasb-f-stp3.png "")
