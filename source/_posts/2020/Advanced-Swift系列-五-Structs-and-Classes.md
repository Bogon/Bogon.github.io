...
![Memeory](http://cdn.xuebaonline.com/awsc-stp1.png "值类型变量是直接包含值的内存中位置的名称。")
...
![Memeory](http://cdn.xuebaonline.com/awsc-stp2.png "引用类型变量包含指向内存中其他地方实际实例的指针。")
...
![Memeory](http://cdn.xuebaonline.com/awsc-stp3.png "视图，窗口和回调之间的引用周期")
