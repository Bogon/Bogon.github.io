...
![playground](http://cdn.xuebaonline.com/sasb-m-stp1.png "")
...
![playground](http://cdn.xuebaonline.com/sasb-m-stp2.png "")
...
![playground](http://cdn.xuebaonline.com/sasb-m-stp3.png "")
...
![playground](http://cdn.xuebaonline.com/sasb-m-stp4.png "")

收集到结构中的类型方法将有利地用Xcode编码完成。 在此示例中，你可以通过键入Math来查看所有可用的math实用程序方法。

![playground](http://cdn.xuebaonline.com/sasb-m-stp5.png "")
